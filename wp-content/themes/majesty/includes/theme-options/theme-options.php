   ...
   Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
			...
			array(
				...
				'desc'	   => esc_html__('Display all shop categories at top of shop page and shop archive.', 'theme-majesty'),
				'default'  => false,
			),
			array(
				'id'       => 'shop_txt_link',
			...
			array(
				'id'       => 'woo_cat_per_row',
				'type'     => 'text',
				'title'    => esc_html__( 'Number Of category display in row for Shop archive', 'theme-majesty' ),
				'validate' => 'numeric',
				'default'  => 4,
			),
			array(
