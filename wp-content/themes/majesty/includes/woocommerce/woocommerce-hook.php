...
// product_cat recent_products products	sale_products	best_selling_products	top_rated_products	featured_products product_attribute
add_action('woocommerce_shortcode_before_product_cat_loop', 'sama_woocommerce_shortcode_products_query', 10);
add_action('woocommerce_shortcode_before_recent_products_loop', 'sama_woocommerce_shortcode_products_query', 10);
add_action('woocommerce_shortcode_before_products_loop', 'sama_woocommerce_shortcode_products_query', 10);
add_action('woocommerce_shortcode_before_sale_products_loop', 'sama_woocommerce_shortcode_products_query', 10);
add_action('woocommerce_shortcode_before_best_selling_products_loop', 'sama_woocommerce_shortcode_products_query', 10);
add_action('woocommerce_shortcode_before_top_rated_products_loop', 'sama_woocommerce_shortcode_products_query', 10);
add_action('woocommerce_shortcode_before_featured_products_loop', 'sama_woocommerce_shortcode_products_query', 10);
add_action('woocommerce_shortcode_before_product_attribute_loop', 'sama_woocommerce_shortcode_products_query', 10);
...
/*
 * Control number of columns for products category
 *
 * @see  sama_woo_cat_loop_columns() 
 * @ since ver 1.4.3
 */
//add_filter('loop_shop_columns', 'sama_woo_cat_loop_columns');
/*
 * Display category in Shop archive 
 *
 * @see  sama_woo_cat_loop_columns() 
 * @ since ver 1.4.3
 */
add_action('woocommerce_before_shop_loop', 'sama_add_shop_categories_for_shop_archive', 200);
add_action('woocommerce_after_shop_loop', 'sama_shop_categories_woo_default', 200);
