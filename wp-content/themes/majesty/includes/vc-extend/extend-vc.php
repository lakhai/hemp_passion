...
if ( class_exists('woocommerce') ) {
	...
	$woo_layout = array(
		''													=> '',
		esc_html__( 'Grid 3 Columns', 	  'theme-majesty') 	=> '37',
		esc_html__( 'Grid Four Columns',  'theme-majesty') 	=> '36',
		esc_html__( 'Grid full width', 	  'theme-majesty') 	=> '35',
		esc_html__( 'Masonry', 			  'theme-majesty') 	=> '33',
		esc_html__( 'Masonry full width', 'theme-majesty') 	=> '34',
		esc_html__( 'List', 			  'theme-majesty') 	=> '31',
		esc_html__( 'List2 Add to Cart Button under image', 'theme-majesty') => '32',
		esc_html__( 'Default WooCommerce 3 Columns', 'theme-majesty') => '3',
		esc_html__( 'Default WooCommerce 4 Columns', 'theme-majesty') => '4',
	);
	vc_map( array(
