...
class Sama_Widget_Socialicon extends WP_Widget {
	...
	function widget ($args, $instance) {
		...
		if ( ! empty( $instance['vk'] ) ) {
			$output .= '<li><a class="social-vk" target="'. $target .'" href="'. esc_url( $instance['vk'] ).'"><i class="fa fa-vk"></i></a></li>';
		}
	...
	?>
		...
		<p><label for="<?php echo $this->get_field_id('vk'); ?>"><?php esc_html_e( 'VK URL:', 'theme-majesty'); ?> </label><input class="widefat" type="text" name="<?php echo $this->get_field_name('vk'); ?>" id="<?php echo $this->get_field_id('vk'); ?>" value="<?php echo esc_attr($instance['vk']); ?>" size="20" /></p>
