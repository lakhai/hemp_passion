...
/*
 *	Used to disable Js for plugin MaxMegaMenu so menu work good in Iphone  
 *	since 1.4.1
 */

function sama_deregister_script_megamenu_plugin() {
	wp_deregister_script('megamenu');
}
 
 add_action( 'wp_enqueue_scripts', 'sama_deregister_script_megamenu_plugin', 1000);
/*
...
function sama_get_option_defaults() {
	$defaults = array(
		...
		'gmaps_api'						=> '',
		'woo_cat_per_row'				=> 4,
		'woo_display_cat_loop'			=> false,
		'default_woocommerce_shop_page_display'	=> '',
		'default_woocommerce_archive_page_display'	=> '',
