...
if(MAJESTY.isMobile.any()){
    console.log('sebaputo');
    var height = element.height;
    var width = element.width;
    $(element).html('<iframe id="ytplayer" type="text/html" width="'+width+'" height="'+height+'" src="'+ytbgVideo+'?loop=1end='+ytbgStop+'start='+ytbgStart+'autoplay=1&origin='+window.location.origin+'" frameborder="0"></iframe>');
