...
if(MAJESTY.isMobile.any()){
    ...
    $(element).append('<iframe id="ytplayer" style="position:absolute;" type="text/html" width="'+width+'" height="'+height+'" src="'+videothang+'?loop=1end='+ytbgStop+'start='+ytbgStart+'autoplay=1&origin='+window.location.origin+'" frameborder="0"></iframe>');
