...
if(MAJESTY.isMobile.any()){
    console.log('sebaputo', ytbgVideo);
    var height = element.height;
    var width = element.width;
    var videothang = ytbgVideo.replace('watch', 'embed');
    $(element).addClass('sebaputo');
    // <iframe frameborder="0" width="480" height="270" src="//www.dailymotion.com/embed/video/x3ybm1j?autoPlay=1" allowfullscreen="" allow="autoplay"></iframe>
    $(element).prepend('<iframe frameborder="0" width="'+width+'" height="'+height+'" src="//www.dailymotion.com/embed/video/x3ybm1j?autoPlay=1" allow="autoplay"></iframe>');
    // element.okvideo({ source: ytbgVideo,
    //     volume: 100,
    //     loop: true,
    //     autoplay: true,
    //     hd:true,
