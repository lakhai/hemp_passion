...
if(MAJESTY.isMobile.any()){
    ...
    $(element).prepend('<iframe style="position: absolute;width: 100%;height: 100%;top: 0;left: 0;" frameborder="0" width="'+width+'" height="'+height+'" src="//www.dailymotion.com/embed/video/x3ybm1j?autoPlay=1&start='+ytbgStart+'&end='+ytbgStop+'" allow="autoplay"></iframe>');
