(function( $ ) {
   "use strict";
	...
	function cartpagesort() {
		// Replace x-remove from first child to last child used in cart page
	...
	$(function() {
		...
		/* single product popup zoom*/
		$('.pswp__button').addClass('btn-number');
		//cart.php
		...
		// used to sort cart table after update cart
		$(document).on( "updated_wc_div",  function() {
			$('.shop_table .product-remove a').html('<i class="fa fa-times"></i>');
			var removexcontent = $('.shop_table tr th.product-remove');
			$('.shop_table tr th.product-remove').remove();
